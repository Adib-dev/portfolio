    ...
    <div id="reviews" className="py-16">
      <div className="container">
        <SectionHeader
          ...
          description="Don't just take my word for it. See what my clients shave to say about
        my work."
        />
              ...
              <Fragment key={idx}>
                {testimonials.map((testimonial) => (
                  <Card
                    ...
                    className="max-w-xs md:max-w-md p-6 md:p-8 hover:scale-1 transition duration-300"
                  >
